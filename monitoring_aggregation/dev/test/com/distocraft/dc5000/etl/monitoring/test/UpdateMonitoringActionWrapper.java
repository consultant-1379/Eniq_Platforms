 ...
 */
	...
	protected void markHolesInMonitoringStatus(String startString,String dateString,String table) throws Exception {
	 ...
	 protected Map getMaxRawCount(String dateString) throws Exception {
	 	return super.getMaxRawCount(dateString);
	 }
	 
	 protected HashSet getReadyRawAggregations(GregorianCalendar currentTime, GregorianCalendar aggTime, String dateString, Map rawCounts,int thresholdHour, int compThresholdHour) throws Exception {	 	
	 	return super.getReadyRawAggregations( currentTime, aggTime, dateString,  rawCounts,thresholdHour, compThresholdHour);
	 }

	  protected HashSet getReadyDAYAggregations(HashSet toBeAggregated, String dateString) throws Exception {
	  	return super.getReadyDAYAggregations( toBeAggregated,  dateString);
	  }
	 
	  protected void updateAggregated(String dateString, HashSet readyToAggregate) throws Exception {
	  	super.updateAggregated( dateString,  readyToAggregate);	  	
	  }
