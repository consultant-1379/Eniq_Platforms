...
public class SimDebuggerCache implements SimDebugger {

  private static SimDebuggerCache pdc = null;
  ...
  public static void initialize() {
    pdc = new SimDebuggerCache();
    pdc.data = new HashMap();
    pdc.dataitems = new HashMap();
  }

  public static SimDebuggerCache getCache() {
    return pdc;
  }
