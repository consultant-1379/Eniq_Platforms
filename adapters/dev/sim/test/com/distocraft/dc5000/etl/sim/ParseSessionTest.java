...
/**
 * Object that is used for information sharing on a sim execution.
 * 
 * @author lemminkainen
 * 
 */
public class ParseSession {
  ...
  private final Properties simConf;

  private final HashMap transformerCache = new HashMap();

  ParseSession(long sessionID, Properties conf) {
  ...
  public String getSimParameter(final String key) {
    return simConf.getProperty(key);
  }
