...
public class ConvertIpAddress implements Transformation {
    ...
    @Override
    public void transform(final Map data, final Logger clog) throws InvalidArgumentsException, IOException {
        ...
        if (input != null) {
            if (input.contains(DOT_SEPARATOR)) {
                ...
                throw new InvalidArgumentsException(input + " is not a valid IPv4 or IPv6 IP address");
            }
     ...
     */
    private String convertIpAddr(final String input, final int numOfIpAddrParts, final String separator) throws InvalidArgumentsException {
