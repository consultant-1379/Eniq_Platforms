...
/**
 * Standalone version of sim which can be executed without ETLC engine
 * 
 */
public class StandaloneMain {

  // TODO check logger name
  private static Logger log = Logger.getLogger("com.distocraft.dc5000.etl.sim.StandaloneMain");
    ...
    try {
      ...
      try {
        rf = new RockFactory(tmpRfEtlRep.getDbURL(), tmpRfEtlRep.getUserName(), tmpRfEtlRep.getPassword(), tmpRfEtlRep
            .getDriverName(), "SimDebugger" + source, true);
      } catch (Exception e) {
