 ...
 * 
 * Represents sourcefile for sim. Also act as holder for configuration
 * object.
 * 
 * @author lemminkainen
 */
...
public class SourceFile {
  ...
  private final RockFactory reprf;

  private final ParseSession psession;

  private final SimDebugger debugger;

  private final List<MeasurementFile> measurementFiles;
  ...
  private final List<ZipEntry> zipEntryList = new ArrayList<ZipEntry>();
  ...
  public SourceFile(File file, Properties conf, RockFactory rf, RockFactory reprf, ParseSession psession,
      SimDebugger debugger, Logger log) {
  ...
  public SourceFile(File file, int memoryConsumptionMB, Properties conf, RockFactory rf, RockFactory reprf, ParseSession psession,
	      SimDebugger debugger, String useZip, Logger log) {
  ...
  /**
   * The way to read sim source file.
   * 
