...
import com.distocraft.dc5000.etl.sim.SimDebugger;
import com.distocraft.dc5000.etl.sim.Transformer;
...
public final class DBTransformer implements Transformer {
  ...
  private SimDebugger simDebugger = null;
  ...
  public void transform(final Map data, final Logger log) throws Exception {
    ...
    while (id.hasNext()) {
      ...
      if (simDebugger != null) {
        simDebugger.beforeTransformation(data);
      }

      t.transform(data, log);

      if (simDebugger != null) {
        simDebugger.afterTransformation(t.getName(), data);
      }
    }
  ...
  public void addDebugger(SimDebugger simDebugger) {
    // TODO Auto-generated method stub
    this.simDebugger = simDebugger;
  }
