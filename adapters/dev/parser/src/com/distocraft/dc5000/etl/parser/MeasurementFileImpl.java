...
/**
 * MeasurementFile of parser. Takes parsed data in by addData methods and writes default form output file. <br>
            ...
            if (outputFormat == IQ_TEXT) {
                ...
                if (bf == null) {
                	log.info("Datatype " + mData.getDataType() + " of data item " + mData.getDataName() + " (of " +
                             dataformat.getTagID() + ") is not supported in binary output mode as the BinaryFormatter is " +bf);
