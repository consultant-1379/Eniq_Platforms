...
/**
 * This class is used to compare the counters from the input MOM file with the database entries in the DC_E_IMS techpack 
 * and give a delta.
 * For IMS, we are only interested in adding new counters to existing meas types.
 * @author esunbal
 *
 */
public class IMSComparator implements CompareInterface {
	  ...
	  private final Logger log = Logger.getLogger(this.getClass().getName());
		...
		public List<AFJMeasurementType> getMeasTypeDelta(final Object object) throws AFJException{
			...
			techPackName = PropertiesUtility.getProperty(PROP_IMS_NAME);
