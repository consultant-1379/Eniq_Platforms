...
public class MTASUpgraderTest {
	  ...
	  private static final String BASE_TP_VERSION = "DC_E_MTAS:((1))";
	  ...
	  private static final String SOME_TP = "DC_E_MTAS";
	  ...
	  public static void setUpBeforeClass() throws Exception {
	    ...
	    try {
	      ...
	      pw.write("dc_e_mtas.interface=INTF_DC_E_MTAS\n");
	      pw.write("datasize.integer=18\n");
	      pw.write("datascale.integer=0\n");
	      pw.write("DC_E_MTAS.datasize.PEG.numeric=20\n");
	      pw.write("DC_E_MTAS.datascale.PEG.numeric=0\n");
	      pw.write("DC_E_MTAS.datasize.GAUGE.numeric=24\n");
	      pw.write("DC_E_MTAS.datascale.GAUGE.numeric=4\n");
	  ...
	  /**
	   * Test method for {@link com.ericsson.eniq.afj.upgrade.MTASUpgrader#upgrade(com.ericsson.eniq.afj.common.AFJDelta)}.
	   * @throws Exception 
	   */
	  @Test
	  public void testUpgrade() throws Exception {
	    ...
	    final MTASUpgrader upgrader = new MTASUpgrader();
