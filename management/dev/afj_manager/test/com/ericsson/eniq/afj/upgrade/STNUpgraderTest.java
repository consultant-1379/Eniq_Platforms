...
public class STNUpgraderTest {
  ...
  private static final String BASE_TP_VERSION = "DC_E_STN:((1))";
  ...
  private static final String SOME_TP = "DC_E_STN";
...
//  private CommonUpgradeUtil mockCommonUpgradeUtil;
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    try {
      ...
      pw.write("dc_e_stn.interface=INTF_DC_E_STN\n");
      pw.write("datasize.integer=18\n");
      pw.write("datascale.integer=0\n");
      pw.write("DC_E_STN.datasize.PEG.numeric=20\n");
      pw.write("DC_E_STN.datascale.PEG.numeric=0\n");
      pw.write("DC_E_STN.datasize.GAUGE.numeric=24\n");
      pw.write("DC_E_STN.datascale.GAUGE.numeric=4\n");
      ...
      pw.write("DC_E_STN.keys=OSS_ID:OSS_ID:1:1:50:varchar:0:HG:255:1:KEY:OSS Id:0:0,NE_KEY:NEKey:0:1:35:varchar:0::255:1:KEY::0:0,SN:SN:0:1:255:varchar:0::255:1:KEY::0:0,MOID:MOID:1:1:255:varchar:0:HG:255:1:KEY:MOID:0:0,NE_NAME:NE_Name:1:1:35:varchar:0:HG:255:1:KEY:NE Name:0:1,NE_VERSION:NE_Version:0:1:35:varchar:0::255:1:KEY::0:0");      
      pw.close();
    } catch (Exception e) {
      e.printStackTrace();
    }
...
//    mockCommonUpgradeUtil = context.mock(CommonUpgradeUtil.class);
...
//    CommonUpgradeUtilFactory.setInstance(mockCommonUpgradeUtil);
...
//    CommonUpgradeUtilFactory.setInstance(null);
  ...
  /**
   * Test method for {@link com.ericsson.eniq.afj.upgrade.STNUpgrader#upgrade(com.ericsson.eniq.afj.common.AFJDelta)}.
   * @throws Exception 
   */
  @Test
  public void testUpgrade() throws Exception {
    ...
    context.checking(new Expectations() {

      {
        ...
        will(returnValue(RAW_TYPE));
        allowing(mockAFJMeasurementType1_2).getDescription();
        will(returnValue("SOME_DESC"));
    ...
    final STNUpgrader upgrader = new STNUpgrader();
