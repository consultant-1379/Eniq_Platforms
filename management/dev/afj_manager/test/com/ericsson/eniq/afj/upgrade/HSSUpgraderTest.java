...
public class HSSUpgraderTest {
	  ...
	  private static final String BASE_TP_VERSION = "DC_E_HSS:((1))";
	  ...
	  private static final String SOME_TP = "DC_E_HSS";
	  ...
	  public static void setUpBeforeClass() throws Exception {
	    ...
	    try {
	      ...
	      pw.write("dc_e_hss.interface=INTF_DC_E_HSS\n");
	      pw.write("datasize.integer=18\n");
	      pw.write("datascale.integer=0\n");
	      pw.write("DC_E_HSS.datasize.PEG.numeric=20\n");
	      pw.write("DC_E_HSS.datascale.PEG.numeric=0\n");
	      pw.write("DC_E_HSS.datasize.GAUGE.numeric=24\n");
	      pw.write("DC_E_HSS.datascale.GAUGE.numeric=4\n");
	  ...
	  /**
	   * Test method for {@link com.ericsson.eniq.afj.upgrade.HSSUpgrader#upgrade(com.ericsson.eniq.afj.common.AFJDelta)}.
	   * @throws Exception 
	   */
	  @Test
	  public void testUpgrade() throws Exception {
	    ...
	    final HSSUpgrader upgrader = new HSSUpgrader();
