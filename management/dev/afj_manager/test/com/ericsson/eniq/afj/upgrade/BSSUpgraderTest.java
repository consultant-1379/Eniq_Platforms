...
public class BSSUpgraderTest {
  ...
  public static void setUpBeforeClass() throws Exception {
	  ...
	  try {
		...
		statement.execute("insert into TPActivation (TECHPACK_NAME,STATUS,VERSIONID,TYPE,MODIFIED) values ('DC_E_BSS','ACTIVE','DC_E_BSS:((1))','PM',1)");
  ...
  /**
   * Test method for {@link com.ericsson.eniq.afj.upgrade.BSSUpgrader#upgrade(com.ericsson.eniq.afj.common.AFJDelta)}.
   * @throws Exception 
   */
  @Test
  public void testUpgrade() throws Exception {
    ...
    final BSSUpgrader upgrader = new BSSUpgrader();
    final String result = upgrader.upgrade(mockAfjDelta);
    assertFalse(result.equals(""));
  }

//	/**
//	 * Test method for {@link com.ericsson.eniq.afj.upgrade.BSSUpgrader#populateMeasurementColumnBaseKeys(final AFJMeasurementType mType, long measColumnNumber) throws AFJException}.
//	 */
//	@Test
...
//	    }
//	    );
//		final BSSUpgrader objectUnderTest = new BSSUpgrader();
//		final AFJDatabaseHandler connection = AFJDatabaseHandler.getInstance();		
//		final Field dwhrep = objectUnderTest.getClass().getDeclaredField("dwhrep");
//		dwhrep.setAccessible(true);
//		dwhrep.set(objectUnderTest, connection.getDwhrep());
//		
...
//		final Method populateMeasurementColumnBaseKeys = pcClass.getDeclaredMethod("populateMeasurementColumnBaseKeys", new Class[] {AFJMeasurementType.class, long.class});
//		populateMeasurementColumnBaseKeys.setAccessible(true);	
//		populateMeasurementColumnBaseKeys.invoke(objectUnderTest, new Object[] {amt, 10l});
//	}
