	...
	public void transform(final Map data, final Logger log) {
		...
		try {
			...
			if (workingDirectory.exists()) {
				log.finest("AlarmTransformation working directory " + workingDirectoryPath + " already exists.");
				...
				log.warning("AlarmData directory " + workingDirectoryPath
						+ " does not exist. Output files will not be created.");
			}
		} catch (Exception e) {
