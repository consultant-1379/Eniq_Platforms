...
public class DiskManagerActionView implements ActionView {
  ...
  public DiskManagerActionView(JPanel parent, Meta_transfer_actions action) {
    ...
    fileAgeDay = new JTextField(new NumericDocument(),getIntParameter(orig, "diskManager.dir.fileAgeDay"), 4);

    fileAgeHour = new JTextField(new NumericDocument(),getIntParameter(orig, "diskManager.dir.fileAgeHour"), 4);

    fileAgeMinutes = new JTextField(new NumericDocument(),getIntParameter(orig, "diskManager.dir.fileAgeMinutes"), 4);
  ...
  public String getContent() throws Exception {
    ...
    p.setProperty("diskManager.dir.fileAgeDay", String.valueOf(Integer.parseInt(fileAgeDay.getText().trim())));
    p.setProperty("diskManager.dir.fileAgeHour", String.valueOf(Integer.parseInt(fileAgeHour.getText().trim())));
    p.setProperty("diskManager.dir.fileAgeMinutes", String.valueOf(Integer.parseInt(fileAgeMinutes.getText().trim())));
  ...
  public String validate() {
    ...
    if(fileAgeHour.getText().length() <= 0) {
      ...
      try {
        ...
        error += "File age in hours is not a valid number.\n";
      }
    }
    ...
    if(fileAgeDay.getText().length() <= 0) {
      ...
      try {
        Integer.parseInt(fileAgeDay.getText());
      } catch(NumberFormatException nfe) {
        error += "File age in days is not a valid number.\n";
      }
    }
    ...
    if(fileAgeMinutes.getText().length() <= 0) {
      ...
      try {
        Integer.parseInt(fileAgeMinutes.getText());
      } catch(NumberFormatException nfe) {
        error += "File age in minutes is not a valid number.\n";
      }
    }
