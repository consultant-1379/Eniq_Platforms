...
/**
 * This class creates the Diskmanager set for the Alarm Interface Wizard. It creates the Diskmanager for the "Alarminterfaces" package.
 * @author berggren
 *
 */
public class CreateAlarmDiskmanager {

  private Logger log = Logger.getLogger("CreateAlarmDiskmanager.create");
   ...
   * @param alarmInterfacesPackage The "Alarminterfaces" package where this Diskmanager is to be created.
   */
  ...
  public void create() {
    ...
    actionContents.setProperty("diskManager.dir.fileAgeHour", "0");
    actionContents.setProperty("diskManager.dir.outDir", this.baseDirectory + this.interfaceName + "/"
        + "archive" + "/");
    ...
    actionContents.setProperty("diskManager.dir.inDir", this.baseDirectory + this.interfaceName + "/"
        + "archive" + "/");
  ...
  private void createDiskmanagerSet() {
    ...
    try {
      ...
      this.diskmanagerSet.setCollection_id(AlarmInterfaceWizardDialog.getNewCollectionId(this.rockFactory,this.frame));
