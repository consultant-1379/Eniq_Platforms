...
/**
 * View to action DuplicateCheck.
 * Copyright (c) 1999 - 2006 AB LM Ericsson Oy  All rights reserved.
 * @author berggren
 */
public class DuplicateCheckActionView implements ActionView {

  private JTextArea clause;
  private Meta_transfer_actions action;
  
  public DuplicateCheckActionView(JPanel parent, Meta_transfer_actions action) {
    this.action = action;
