...
public class ScheduleTableRenderer extends JLabel implements TableCellRenderer, Serializable {
  ...
  public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
    ...
    ScheduleTableModel stm = (ScheduleTableModel) ts.getTableModel();

    Meta_schedulings ms = stm.getActionAt(ts.modelIndex(row));
    ...
    if (isSelected) {
      ...
      if (ms.getHold_flag().equalsIgnoreCase("y")) {
