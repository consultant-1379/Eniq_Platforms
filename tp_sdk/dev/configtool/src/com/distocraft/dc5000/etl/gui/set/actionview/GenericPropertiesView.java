    ...
    while (keys.hasMoreElements()) {
      ...
      if (usedParams.contains(key)) {
        ...
        while(i.hasNext()) {
          ...
          System.out.println("Used: " + usedKey);
  ...
  public class GPVMouseListener extends MouseAdapter {
    ...
    public void mouseClicked(final MouseEvent e) {
      ...
      if (e.getButton() == MouseEvent.BUTTON3) { // PopUp Menu
        ...
        final JMenuItem atp = new JMenuItem("Create new Parameter", ConfigTool.newIcon);
        ...
        pop.add(atp);
        if (row >= 0) {
          final JMenuItem inp = new JMenuItem("Delete this Parameter", ConfigTool.delete);
