...
public class UncompressActionView implements ActionView {
  ...
  public UncompressActionView(JPanel aparent, Meta_transfer_actions action) {
    ...
    String[] compressors = { "com.distocraft.dc5000.uncompress.Tar", "com.distocraft.dc5000.uncompress.Uncompress","com.distocraft.dc5000.uncompress.Zip" };
    ...
    directorySeparator.setToolTipText("String that is added to the filename (output file) between directory and actual filename.");
  ...
  private void makeLayout(){
    ...
    if (addSeparator.getSelectedIndex() == 1){
      ...
      l_directorySeparator.setToolTipText("String that is added to the filename (output file) between directory and actual filename.");
