...
/**
 * Class for rendering one cell in activationselector.
 ...
 * @author berggren
 */
public class ActivationSelectorCellRenderer extends JLabel implements TreeCellRenderer {
  ...
  public ActivationSelectorCellRenderer() {
  ...
  public Component getTreeCellRendererComponent(JTree tree, Object value, boolean sel, boolean expanded, boolean leaf,
    ...
    } else if (o instanceof Tpactivation) {
      Tpactivation tpactivation = (Tpactivation) o;

      setText(tpactivation.getTechpack_name());

      if (tree.isEnabled())
        // Check if the tpactivation's state is active and set the icon accordingly.
        if (tpactivation.getStatus().equalsIgnoreCase("ACTIVE")) {
          setIcon(metadataIcon);
        } else {
          setIcon(inactiveMetadataIcon);
        }
      else
