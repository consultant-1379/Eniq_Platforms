...
/**
 * This class creates the Adapter set for the Alarm Interface Wizard. It creates the Adapter for the "Alarminterfaces" package.
 * @author berggren
 *
 */
public class CreateAlarmAdapter {

  private Logger log = Logger.getLogger("CreateAlarmAdapter.create");
   ...
   * @param alarmInterfacesPackage The "Alarminterfaces" package where this Adapter is to be created.
   * @param frame JFrame object to show error window.
   */
  ...
  private void createAdapterSet() {
    ...
    try {
      ...
      this.adapterSet.setCollection_id(AlarmInterfaceWizardDialog.getNewCollectionId(this.rockFactory,this.frame));
  ...
  private void createAction(String actionType, String transferActionName, Long actionOrder, String description,
      String whereClause, Properties actionContents, String enabledFlag, Long connectionId) {
