...
public class TypeActivationTableRenderer extends JLabel implements TableCellRenderer, Serializable {
  ...
  public TypeActivationTableRenderer() {
    super();
  ...
  public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
    ...
    TypeActivationTableModel typeActivationTableModel = (TypeActivationTableModel) ts.getTableModel();

    Typeactivation typeActivation = typeActivationTableModel.getTypeActivationAt(ts.modelIndex(row));
