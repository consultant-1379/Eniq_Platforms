        ...
        While (dbReader.Read())
            ...
            Else
                ...
                If dbReader.FieldCount < 4 Then
                    univ_cls.UniverseExtension = ""
                Else
                    univ_cls.UniverseExtension = LCase(dbReader.GetValue(3).ToString())
                End If
                If dbReader.FieldCount < 5 Then
                    univ_cls.ObjectBHRelated = False
                Else
                    univ_cls.ObjectBHRelated = dbReader.GetValue(4).ToString()
                End If
                If dbReader.FieldCount < 6 Then
                    univ_cls.ElementBHRelated = False
                Else
                    univ_cls.ElementBHRelated = dbReader.GetValue(5).ToString()
                End If
