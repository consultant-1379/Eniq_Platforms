...
'
Public NotInheritable Class BOClasses
    ...
    Public Class BOClass
        ...
        Private m_Classes As BOClasses
        Private m_Objects As BOObjects
        Private m_Conditions As BOConditions
        ...
        Public Property Classes() As BOClasses
            Get
                Classes = m_Classes
            End Get

            Set(ByVal Value As BOClasses)
                m_Classes = Value
            End Set
        ...
        Public Property Objects() As BOObjects
            Get
                Objects = m_Objects
            End Get

            Set(ByVal Value As BOObjects)
                m_Objects = Value
            End Set
        ...
        Public Property Conditions() As BOConditions
            Get
                Conditions = m_Conditions
            End Get

            Set(ByVal Value As BOConditions)
                m_Conditions = Value
            End Set
