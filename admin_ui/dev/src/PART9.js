...
"<h1><span class=\"CHAPNUMBER\">9 &nbsp; </span><span class=\"CHAPTITLE\"><a name=\"id_ruhd\"></a><a name=\"CHAPTER9\" href='javascript:parent.parent.sC2(\"TOP\")' class=\"CHAPLINK\">Update OSS IP address</a></span></h1>\n" +
"\n" +
"<p>\n" +
...
"\n" +
"<p>\n" +
"<tt class=\"input\"><b>#[root] bash ./manage_oss_ip.bsh -h  &lt;eniq_alias&gt; [-l\n" +
"&lt;path_to_logfile&gt;]</b></tt></p>\n" +
"\n" +
...
"\n" +
"<p>\n" +
"You will be asked to confirm the details entered. Select &ldquo;Y&rdquo;\n" +
...
"<p>\n" +
"SPARC OSS systems must be re-mounted. Refer to chapter 6 \"Mount\n" +
"OSS_RC Master Server on ENIQ\" in <a href='javascript:parent.parent.parent.showAnchor(\"OSSRCConfigForEniq\")' class=\"xref\">Reference [22]</a> for instructions.</p>\n" +
"\n" +
"\n"+
"</div>\n";
