...
"<h1><span class=\"CHAPNUMBER\">27 &nbsp; </span><span class=\"CHAPTITLE\"><a name=\"id_ubpc\"></a><a name=\"CHAPTER27\" href='javascript:parent.parent.sC2(\"TOP\")' class=\"CHAPLINK\">ENIQ Services</a></span></h1>\n" +
"\n" +
"<p>\n" +
"In <a name=\"tbl-EniqServices\" href='javascript:parent.parent.parent.showAnchor(\"tbl-EniqServices\")' class=\"xref\"> Table 23</a>, each ENIQ service and other\n" +
"important services are described.</p>\n" +
"\n" +
"\n" +
"<a name=\"TABLE23\"></a>\n" +
"<table class=\"tblcnt\" width=\"100%\">\n" +
"<caption>Table 23 &nbsp;&nbsp; ENIQ and other important services</caption>\n" +
"<tr valign=\"top\">\n" +
...
"</td>\n" +
"<td align=\"left\" width=\"51%\">\n" +
"<p>Responsible for communication between two services running\n" +
...
"</td>\n" +
"<td align=\"left\" width=\"51%\">\n" +
"<p>Scheduler is clock of platform which runs every single\n" +
"second and check which sets are supposed to be executed</p>\n" +
"</td>\n" +
"<td align=\"left\" width=\"26%\">\n" +
"<p>Coordinator</p>\n" +
"</td></tr>\n" +
...
"</td>\n" +
"<td align=\"left\" width=\"51%\">\n" +
"<p>Responsible for all database read and write operatons.Same\n" +
"service will be responsible for read operations on reader server and\n" +
...
"</td>\n" +
"<td align=\"left\" width=\"51%\">\n" +
"<p>Monitors local ENIQ SMF services and clear&rsquo;s and\n" +
"starts any service that have gone into Maintenance</p>\n" +
"</td>\n" +
"<td align=\"left\" width=\"26%\">\n" +
"<p>All</p>\n" +
"</td></tr>\n" +
...
"for updates to hosts master file and update local hosts file if required</p>\n" +
"</td>\n" +
"<td align=\"left\" width=\"26%\">\n" +
"<p>All</p>\n" +
"</td></tr>\n" +
...
"</td>\n" +
"<td align=\"left\" width=\"51%\">\n" +
"<p>The rolling snapshot is designed to be a self-maintaining\n" +
"mechanism. It creates and deletes snapshots of the ENIQ Events server\n" +
"when required</p>\n" +
"</td>\n" +
"<td align=\"left\" width=\"26%\">\n" +
"<p>All</p>\n" +
...
"\n" +
"<p><tt class=\"input\"><b>svcs -l &lt;service_name&gt;</b></tt></p>\n" +
"\n"+
"</div>\n";
