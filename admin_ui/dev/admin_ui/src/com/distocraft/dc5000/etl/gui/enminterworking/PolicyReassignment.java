...
//import com.distocraft.dc5000.etl.gui.monitor.ShowPartitionPlan;
			...
			if (!regexString.isEmpty()) {
				...
				if (pc.isPatternMatching(regexString) || regexString.equals("*")) {
					...
					if (!pc.isCombinationExists(technology, regexString, identifier, dwhrep)) {
						log.info("Updating the policies.");
						pc.updatePolicy(oldTechnology, technology, oldNaming, regexString, oldIdentifier, identifier,
								dwhrep);
