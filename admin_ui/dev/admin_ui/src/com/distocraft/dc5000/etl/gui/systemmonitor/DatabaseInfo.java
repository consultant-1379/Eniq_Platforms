...
/*  *//**
  ...
  */
   ...
   * @param otherVersion
   */
  public void parseSize(final String mainiqrow, final String pagesize, final String version, final String otherVersion, final String backuptime) {
    try {
      ...
      */
      ...
      sb.append((int)usedSpaceMb + " MB");
      sb.append(" (" + (int)((usedSpaceMb/totalSpaceMb) * 100) + "%).");
      sb.append(" Available " + ((int) (totalSpaceMb - usedSpaceMb)) + " MB.");
