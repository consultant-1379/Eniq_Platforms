...
public class EditLogging extends EtlguiServlet { // NOPMD by eheijun on 02/06/11 14:48
      ...
      if (params.size() > 0) {
        ...
        while (iter.hasNext()) {        	
                ...
                if( i<=Integer.parseInt(maxloglimit)){               
                	...
                	changeLogginglevel(key, value, engProp, licProp, schProp,i,finelogvalue,finerlogvalue,finestlogvalue,ctx);                         
  ...
  public void changeLogginglevel(String key,String value,Properties engProp,Properties licProp,Properties schProp,int i,String finelogvalue,String finerlogvalue,String finestlogvalue,Context ctx){               
      String oldValue;
      boolean a=true;
