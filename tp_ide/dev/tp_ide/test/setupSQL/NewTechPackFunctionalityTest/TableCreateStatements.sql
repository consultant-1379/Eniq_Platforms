CREATE TABLE Grouptypes (GROUPTYPE VARCHAR(64), VERSIONID VARCHAR(128), DATANAME VARCHAR(128), DATATYPE VARCHAR(50), DATASIZE INT, DATASCALE INT, NULLABLE SMALLINT);
...
create table MeasurementType (
	...
	SONAGG int, SONFIFTEENMINAGG int, ROPGRPCELL varchar(255)
);
