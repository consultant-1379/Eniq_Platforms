...
public class BackupLoaderActionViewTest {

  BackupLoaderActionView objUnderTest;

  @Before
  public void setUp() {
    final JPanel parent = new JPanel();
    objUnderTest = new BackupLoaderActionView(parent);
  }

  @Test
  public void checkThatGetTypeReturnsCorrectString() {
    assertEquals("BackupLoader", objUnderTest.getType());
  }
