...
/**
 * Test for RestoreActionView
 * @author epaujor
 * @since 2012
 *
 */
public class RestoreActionViewTest extends BaseUnitTestX {

  RestoreActionView objUnderTest;
  ...
  public void setUp() {
    ...
    objUnderTest = new RestoreActionView(parent, mockMetaTransferActions);
  }

  @Test
  public void checkThatGetTypeReturnsCorrectString() {
    assertEquals("Restore", objUnderTest.getType());
  }

  @Test
  public void checkThatValidateReturnsCorrectString() throws IOException {
    objUnderTest = new RestoreActionView(parent, null);
