...
public class TopologySQLExecuteActionViewTest extends BaseUnitTestX {

  private TopologySQLExecuteActionView objUnderTest;
  ...
  private final static String EXPECTED_WHERE_CLAUSE = "tableName=TesttableName";
  ...
  public void setUp() {
    ...
    objUnderTest = new TopologySQLExecuteActionView(parent, mockMetaTransferActions);
  }

  @Test
  public void checkThatGetTypeReturnsCorrectString() {
    assertEquals("TopologySqlExecute", objUnderTest.getType());
  }
  ...
  public void checkThatValidateMessageReturnsMessageWhenVelocityTemplateIsEmpty() {
    objUnderTest = new TopologySQLExecuteActionView(parent, null);
    assertEquals("Parameter SQL Template must be defined\nParameter Topology Table Name must be defined\n",
        objUnderTest
        .validate());
  }
  ...
  public void checkThatGetWhereReturnsCorrectString() throws IOException {
    assertTrue(objUnderTest.getWhere().contains("tableName=TesttableName"));
  }
