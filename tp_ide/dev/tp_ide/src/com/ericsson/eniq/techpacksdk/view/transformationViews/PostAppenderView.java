 ...
 * 
 */
public class PostAppenderView extends GenericTransformationView {
  ...
  public PostAppenderView(JPanel parent, Transformation transformation) {
    super();
    ...
    // factor
    String name = "field";
    String toolTip = "Name of the field which is postappended to the field source.";
    c.gridx = 0;
    c.gridy = 0;
    ...
    // factorfield
    name = "fixed";
    toolTip = "Fixed value which is postappended to the field source.";
    c.gridx = 0;
    c.gridy++;
