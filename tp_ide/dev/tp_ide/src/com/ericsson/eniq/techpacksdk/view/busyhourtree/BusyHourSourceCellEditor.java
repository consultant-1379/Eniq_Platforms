...
/**
 * This class is a customized table cell editor for busyhour source
 * 
 * @author eheijun
 */
@SuppressWarnings("serial")
public class BusyHourSourceCellEditor extends AbstractCellEditor implements TableCellEditor, ActionListener {
   ...
   */
  public BusyHourSourceCellEditor(Application application, boolean editable) {
  ...
  public Component getTableCellEditorComponent(final JTable table, final Object value, final boolean isSelected,
    ...
    busyHourSourceTableModel = (BusyHourSourceTableModel) value;
    theComp = new TableComponent(application, "Busy Hour Source", busyHourSourceTableModel, 150, tableEditable);
  ...
  public Object getCellEditorValue() {
    return busyHourSourceTableModel.getData();
  }
