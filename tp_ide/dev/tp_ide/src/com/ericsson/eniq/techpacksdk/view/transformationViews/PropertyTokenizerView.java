 ...
 * 
 */
public class PropertyTokenizerView extends GenericTransformationView {
  
  private JTextField delimTF = null;

  public PropertyTokenizerView(JPanel parent, Transformation transformation) {
    super();
    ...
    //old
    String name = "delim";
    String toolTip = "Delimeter string used for the tokenization.";
    c.gridx = 0;
    c.gridy = 0;
