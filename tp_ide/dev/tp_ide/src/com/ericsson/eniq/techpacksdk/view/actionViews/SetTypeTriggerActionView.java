...
public class SetTypeTriggerActionView implements ActionView {
  ...
  public static final String[] SET_TYPES = { "Adapter", "Aggregator", "Alarm", "Install", "Loader",
      "Mediation", "Partition", "Service", "Support", "Topology" };
  ...
  public SetTypeTriggerActionView(JPanel parent, Meta_transfer_actions action) {
    ...
    setType = new JComboBox(SET_TYPES);
