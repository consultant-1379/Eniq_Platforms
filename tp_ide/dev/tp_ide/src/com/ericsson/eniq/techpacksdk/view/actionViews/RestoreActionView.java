...
/**
 * Used for creating restore action in techpack IDE
 * 
 * @author epaujor
 * @since 2012
 * 
 */
public class RestoreActionView implements ActionView {

  private transient static final Logger LOG = Logger.getLogger("RestoreActionView");

  private transient final JTextField sourceType;

  private transient final JCheckBox isVolBasedPartition;

  public RestoreActionView(final JPanel parent, final Meta_transfer_actions action) {
