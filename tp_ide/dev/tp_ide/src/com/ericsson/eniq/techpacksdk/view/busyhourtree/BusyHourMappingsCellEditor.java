...
/**
 * This class is a customised table cell editor for busyhour mappings.
 * 
 * @author eheitur
 */
@SuppressWarnings("serial")
public class BusyHourMappingsCellEditor extends AbstractCellEditor implements TableCellEditor, ActionListener {
   ...
   */
  public BusyHourMappingsCellEditor(Application application, boolean editable) {
  ...
  public Component getTableCellEditorComponent(final JTable table, final Object value, final boolean isSelected,
    ...
    busyHourMappingsTableModel = (BusyHourMappingsTableModel) value;
    theComp = new TableComponent(application, "Busy Hour Mappings", busyHourMappingsTableModel, 150, tableEditable);
  ...
  public Object getCellEditorValue() {
    return busyHourMappingsTableModel.getData();
  }
