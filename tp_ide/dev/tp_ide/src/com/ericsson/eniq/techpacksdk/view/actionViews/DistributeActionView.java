...
public class DistributeActionView implements ActionView {
  ...
  public void printLayout() {
    ...
    l_minFileAge
        .setToolTipText("Min age of the distributet file in minutes. File must be at least this old to be distributet.");
    ...
    if (bufferType.getSelectedIndex() > 0) {
      ...
      l_bufferSize
          .setToolTipText("Size of the buffer (characters read from the begining of the file) where matching is done.");
