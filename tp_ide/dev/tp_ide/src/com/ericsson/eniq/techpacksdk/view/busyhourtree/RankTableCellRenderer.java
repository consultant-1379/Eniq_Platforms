 ...
 * 
 */
public class RankTableCellRenderer extends JPanel implements TableCellRenderer {
   ...
   * @param items
   */
  public RankTableCellRenderer(boolean editable) {
  ...
  public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
    ...
    if (value instanceof Busyhour) {
      ...
      textField.setText(bh.getBhlevel());
    } else {
      textField.setText("?");
    }
    return this;
