 ...
 * 
 */
public class PropertiesTableCellRenderer extends JPanel implements
		TableCellRenderer {
	...
	public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        Meta_transfer_actions mta = (Meta_transfer_actions)value;
        
		// Set text value shown in the text field and return the component.
		textField.setText(mta.getAction_contents());
		return this;
	}
}
