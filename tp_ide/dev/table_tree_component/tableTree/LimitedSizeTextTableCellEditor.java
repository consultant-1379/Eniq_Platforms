 ...
 * 
 */
public class LimitedSizeTextTableCellEditor extends DefaultCellEditor {
     ...
     * has no real effect here, because it is not possible to empty the cell
     * value for an integer. The cell editing is always canceled if a null or an
     * empty value is given.
     * 
     * @param colums
     * @param limit
     * @param required
     */
    public LimitedSizeTextTableCellEditor(int colums, int limit,
	    boolean required) {
