...
public class MeasurementkeyFactory implements Cloneable {
  ...
  public MeasurementkeyFactory(RockFactory rockFact, Measurementkey whereObject) throws SQLException, RockException {
  ...
  public boolean equals(Vector otherVector) {
    ...
    for (int i = 0; i < this.vec.size(); i++) {
      MeasurementkeyFactory o = (MeasurementkeyFactory) this.vec.elementAt(i);
      MeasurementkeyFactory otherO = (MeasurementkeyFactory) otherVector.elementAt(i);
