 ...
 * 
 */
public class TechPackUpgradeTest {  

  private static TechPackIdeStarter starter;

  public static junit.framework.Test suite() {
    return new JUnit4TestAdapter(TechPackUpgradeTest.class);
  }
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++");
    System.out.println("Executing test class: TechPackUpgrade");
    System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++");
...
//    robot = TechPackIdeStarter.getMyRobot();
   ...
   * Return to the Manage DWH tab and select the TP upgrade it
   * 
   * @throws Exception
   */  
  @org.junit.Test
  public void testUpdgradeTechPack() throws Exception{
    System.out.println("testUpdgradeTechPack(): Start.");   
    ...
    TechPackIdeStarter.getMyWindow().button("DWHUpgrade").requireEnabled();
    
    TechPackIdeStarter.getMyWindow().button("DWHUpgrade").click();    
    ...
    assertThat( TechPackIdeStarter.getMyWindow().button("DWHActivate").target.isEnabled())
		.as("After Upgrade Activate button sould be disabled if not then Upgrade is failed").isFalse();
    ...
    System.out.println("testUpdgradeTechPack(): Done.");
  }
  /**
   * A Helper method.
